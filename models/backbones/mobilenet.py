...
class MobileNetV2(nn.Module):
    def __init__(
        ...
        self.num_out_feats = [
            inverted_residual_setting["setting1"][0][1],
        ...
        self.conv_bn_relu1 = ConvBNReLU(
            3 if is_color else 1, self.input_channel, stride=2
        )
...
def MobileNetA(is_color=True, **kwargs):
    ...
    inverted_residual_setting = {
        "setting0": [[1, 16, 1, 1], [6, 24, 2, 2], [6, 32, 3, 2]],
        "setting1": [[6, 64, 4, 2]],
        "setting2": [[6, 96, 3, 1]],
        "setting3": [[6, 160, 3, 2]],
        "setting4": [[6, 320, 1, 1]],
    ...
    model = MobileNetV2(
        is_color=is_color, inverted_residual_setting=inverted_residual_setting
    )
    return model
