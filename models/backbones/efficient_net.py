...
def efficientnet_b0_pretrained(**kwargs):
    return EfficientNet.from_pretrained(
        "efficientnet-b0",
        weights_path="/mnt/lustre/share/zhubeier/pretrained_model/efficientnet-b0.pth",
    )
...
def efficientnet_b1_pretrained(**kwargs):
    return EfficientNet.from_pretrained(
        "efficientnet-b1",
        weights_path="/mnt/lustre/share/zhubeier/pretrained_model/efficientnet-b1.pth",
    )
