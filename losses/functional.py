...
__all__ = [
    ...
    "smooth_wing_loss",
    "wider_wing_loss",
    "normalized_wider_wing_loss",
]


def l2_loss(prediction: torch.Tensor, target: torch.Tensor, reduction="mean"):
...
def euclidean_loss(prediction: torch.Tensor, target: torch.Tensor, reduction="mean"):
